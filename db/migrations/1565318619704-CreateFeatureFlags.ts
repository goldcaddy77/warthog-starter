...
export class CreateFeatureFlags1565318619704 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(`ALTER TABLE "users" ADD "key" character varying(20) NOT NULL`);
    await queryRunner.query(
      `ALTER TABLE "users" ADD CONSTRAINT "UQ_93f18065a2dd9f6b26c138b37ce" UNIQUE ("key")`
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "UQ_93f18065a2dd9f6b26c138b37ce"`);
    await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "key"`);
    await queryRunner.query(`ALTER TABLE "users" ADD "email" character varying NOT NULL`);
    await queryRunner.query(
      `ALTER TABLE "users" ADD CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email")`
    );
    await queryRunner.query(`ALTER TABLE "users" ADD "status" character varying(30) NOT NULL`);
    ...
    await queryRunner.query(`DROP TABLE "feature_flag_segments"`);
    await queryRunner.query(`DROP TABLE "segments"`);
    await queryRunner.query(`DROP TABLE "user_segments"`);
    await queryRunner.query(`DROP TABLE "feature_flag_users"`);
  }
}
